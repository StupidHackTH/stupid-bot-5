...
// const cp3 = ColorPicker(["000000", "FFFFFF"])
// console.log(cp3.Query(0.5))

// const cp4 = ColorPicker(["000000", "FF0000", "00FF10"])
// for (let i = 0; i <= 11; i++) {
//     console.log(i.toString() + ": " + cp4.Query(i / 11))
// }
